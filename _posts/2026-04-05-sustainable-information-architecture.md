...
excerpt_en: "Whatever you build must be able to run without you. Designing information architecture for organizations with no dedicated IT staff."
excerpt_zh: "資源受限組織在資訊架構上面臨的挑戰比一般企業更嚴峻。你建的任何系統，都必須能夠自己跑下去。"
---
